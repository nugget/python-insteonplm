...
class OnOffSwitch_OutletBottom(StateBase):
    ...
    def __init__(self, address, statename, group, send_message_method, set_message_callback_method, defaultvalue=None):
        ...
        self._message_callbacks.add(ExtendedReceive.template(commandtuple=COMMAND_LIGHT_ON_0X11_NONE,
                                                             userdata={'d1': 0x02},
                                                             address=self._address,
                                                             flags=MessageFlags.template(MESSAGE_TYPE_ALL_LINK_CLEANUP, None)), 
                                    self._on_message_received)
        self._message_callbacks.add(ExtendedReceive.template(commandtuple=COMMAND_LIGHT_ON_FAST_0X12_NONE,
                                                             userdata={'d1': 0x02},
                                                             address=self._address,
                                                             flags=MessageFlags.template(MESSAGE_TYPE_ALL_LINK_CLEANUP, None)), 
                                    self._on_message_received)
        self._message_callbacks.add(ExtendedReceive.template(commandtuple=COMMAND_LIGHT_OFF_0X13_0X00,
                                                             userdata={'d1': 0x02},
                                                             address=self._address,
                                                             flags=MessageFlags.template(MESSAGE_TYPE_ALL_LINK_CLEANUP, None),
                                                             cmd2=None), 
                                    self._off_message_received)
        self._message_callbacks.add(ExtendedReceive.template(commandtuple=COMMAND_LIGHT_OFF_FAST_0X14_0X00,
                                                             userdata={'d1': 0x02},
                                                             address=self._address,
                                                             flags=MessageFlags.template(MESSAGE_TYPE_ALL_LINK_CLEANUP, None),
                                                             cmd2=None), 
                                    self._off_message_received)
        self._message_callbacks.add(ExtendedReceive.template(commandtuple=COMMAND_LIGHT_MANUALLY_TURNED_OFF_0X22_0X00,
                                                             userdata={'d1': 0x02},
                                                             address=self._address, 
                                                             flags=MessageFlags.template(MESSAGE_TYPE_ALL_LINK_CLEANUP, None),
                                                             cmd2=None), 
                                    self._manual_change_received)
        self._message_callbacks.add(ExtendedReceive.template(commandtuple=COMMAND_LIGHT_MANUALLY_TURNED_ON_0X23_0X00,
                                                             userdata={'d1': 0x02},
                                                             address=self._address, 
                                                             flags=MessageFlags.template(MESSAGE_TYPE_ALL_LINK_CLEANUP, None),
                                                             cmd2=None), 
