...
class SecurityHealthSafety(DeviceBase):
    ...
    def __init__(self, plm, address, cat, subcat, product_key=None, description=None, model=None):
        ...
        self._stateList[0x01] = OnOffSensor(self._address, "onOffSensor", 0x01, self._plm.send_msg, self._plm.message_callbacks, 0x00)
...
class SecurityHealthSafety_2982_222(DeviceBase):
    ...
    def __init__(self, plm, address, cat, subcat, product_key=None, description=None, model=None):
        ...
        self._stateList[0x01] = SmokeCO2Sensor(self._address, "smokeCO2Sensor", 0x01, self._plm.send_msg, self._plm.message_callbacks, 0x00)