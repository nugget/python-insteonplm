...
COMMAND_SPRINKLER_CONTROLLOAD_INITIALIZATION_VALUES_0X44_0X00 = {'cmd1':0x44,'cmd2':0x00}
...
COMMAND_SPRINKLER_CONTROLINHIBIT_COMMAND_ACCEPTANCE_0X44_0X03 = {'cmd1':0x44,'cmd2':0x03}
COMMAND_SPRINKLER_CONTROLRESUME_COMMAND_ACCEPTANCE_0X44_0X04 = {'cmd1':0x44,'cmd2':0x04}
...
COMMAND_IO_MODULE_CONTROLLOAD_INITIALIZATION_VALUES_0X4F_0X00 = {'cmd1':0x4F,'cmd2':0x00}
...
COMMAND_IO_MODULE_CONTROLENABLE_STATUS_CHANGE_MESSAGE_0X4F_0X09 = {'cmd1':0x4F,'cmd2':0x09}
COMMAND_IO_MODULE_CONTROLDISABLE_STATUS_CHANGE_MESSAGE_0X4F_0X0A = {'cmd1':0x4F,'cmd2':0x0A}
...
COMMAND_THERMOSTAT_CONTROLLOAD_INITIALIZATION_VALUES_0X6B_0X00 = {'cmd1':0x6B,'cmd2':0x00}
COMMAND_THERMOSTAT_CONTROLLOAD_EEPROM_FROM_RAM_0X6B_0X01 = {'cmd1':0x6B,'cmd2':0x01}
COMMAND_THERMOSTAT_CONTROLGET_THERMOSTAT_MODE_0X6B_0X02 = {'cmd1':0x6B,'cmd2':0x02}
COMMAND_THERMOSTAT_CONTROLGET_AMBIENT_TEMPERATURE_0X6B_0X03 = {'cmd1':0x6B,'cmd2':0x03}
...
COMMAND_THERMOSTAT_CONTROLGET_EQUIPMENT_STATE_0X6B_0X0D = {'cmd1':0x6B,'cmd2':0x0D}
COMMAND_THERMOSTAT_CONTROLSET_EQUIPMENT_STATE_0X6B_0X0E = {'cmd1':0x6B,'cmd2':0x0E}
COMMAND_THERMOSTAT_CONTROLGET_TEMPERATURE_UNITS_0X6B_0X0F = {'cmd1':0x6B,'cmd2':0x0F}
COMMAND_THERMOSTAT_CONTROLSET_FAHRENHEIT_0X6B_0X10 = {'cmd1':0x6B,'cmd2':0x10}
COMMAND_THERMOSTAT_CONTROLSET_CELSIUS_0X6B_0X11 = {'cmd1':0x6B,'cmd2':0x11}
COMMAND_THERMOSTAT_CONTROLGET_FAN_ON_SPEED_0X6B_0X12 = {'cmd1':0x6B,'cmd2':0x12}
COMMAND_THERMOSTAT_CONTROLSET_FAN_ON_SPEED_LOW_0X6B_0X13 = {'cmd1':0x6B,'cmd2':0x13}
COMMAND_THERMOSTAT_CONTROLSET_FAN_ON_SPEED_MEDIUM_0X6B_0X14 = {'cmd1':0x6B,'cmd2':0x14}
COMMAND_THERMOSTAT_CONTROLSET_FAN_ON_SPEED_HIGH_0X6B_0X15 = {'cmd1':0x6B,'cmd2':0x15}
COMMAND_THERMOSTAT_CONTROLENABLE_STATUS_CHANGE_MESSAGE_0X6B_0X16 = {'cmd1':0x6B,'cmd2':0x16}
COMMAND_THERMOSTAT_CONTROLDISABLE_STATUS_CHANGE_MESSAGE_0X6B_0X17 = {'cmd1':0x6B,'cmd2':0x17}
...
MESSAGE_SEND_EXTENDED_MESSAGE_0X62 =  0x62 # Flag bit determines STANDARD vs EXTENDED
...
MESSAGE_FLAG_DIRECT_MESSAGE_ACK_0X20 =  0x20 # USE CAREFULLY. ACK is defined as 0x20 bit set to Zero. See isackflag for proper use.
...
MESSAGE_FLAG_HOPS_LEFT_0X0C =  0x0c # Need to shift two bits right to get the actual count
